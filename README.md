...
The .txt files added to the repo are examples of results with subnet-scanner ran against a metasploitable2 host (192.168.0.100) blocking ICMP and a Vulnub's kioptrix VM (192.168.0.121) allowing ICMP.  
